  ...
  return (
    <nav className='p-6 shadow-lg flex items-center justify-between mb-4'>
      ...
      <div className='flex text-blue-400 font-bold'>
        ...
        <div className={`${showMenu ? 'translate-x-0' : 'translate-x-full'} transition duration-300 md:translate-x-0
        absolute border md:static flex flex-col md:flex-row md:border-0
